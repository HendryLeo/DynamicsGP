...
I am using alternate modified window, so create assembly with
dag id <your DYNAMICS.SET> /M, for the alternate form
dag id <your DYNAMICS.SET> /F, for the modified form
